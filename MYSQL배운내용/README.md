...
-- 4. 재직중(ent_yn 칼럼값이 'N')인 사원들의 사번, 사원명, 입사일(hire_date) 조회  
...
-- 6. 보너스 포함 연봉이 NULL이 아니고 이름에 '하'가 포함되어 있는 사원들의 사번(emp_id), 사원명(emp_name), 급여(salary), 보너스(bonus) 포함 연봉(별칭부여) 조회
