...
// eq(n) : 선택된 요소등 중 인덱스 번호와 일치하는 요소 선택 (0부터 시작)
...
// parents(['선택자']) : 선택된 요소의 모든 상위 요소를 선택하거나, 매개변수가 있으면 매개변수와
// 일치하는 상위 요소만 선택
...
//  parentsUntil(['선택자']) : 선택된 요소의 모든 상위 요소를 선택하거나, 매개변수가 있으면
// 선택된 요소부터 매개변수와 일치하는 요소까지의 상위 요소 선택

// span 요소부터 div 요소 이전까지 상위 요소에 배경색 : lavenderblush
$("span").parentsUntil("div").css("background-color", "lavenderblush");

// children(['선택자']) : 선택된 요소의 모든 자식 요소를 선택하거나 매개변수가 있으면
// 매개변수와 일치하는 자식 요소만 선택
console.log($(".wrap").children());
// find('선택자') : 선택된 요소의 하위 요소 중 매개변수와 일차하는 모든 하위요소 선택
...
// 클래스가 wrap인 요소의 자식 요소들에 style1 적용
...
// 3. Sideways 메서드
// siblings(['선택자']) : 선택된 요소와 같은 레벨에 있는 모든 요소를 선택하거나 매개변수가 있으면
// 같은 레벨 요소 중 매개변수화 일치하는 요소 선택
...
// nextUntil(['선택자']) : 선택된 요소와 같은 레벨 요소 중 다음의 모든 요소를 선택하거나,
// 매개변수가 있으면 같은 레벨의 다음 요소 중 매개변수와 일치하는 요소까지 선택
...
// 매개변수가 있으면 같은 레벨의 이전 요소 중 매개변수와 일치하는 요소까지 선택
